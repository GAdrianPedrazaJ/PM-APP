 ...
 */
export const withClientSideSessionMiddleware = ({ auth, storage, graphql, functions, sessionStorage, }) => {
    const mwChain = [
 ...
 */
export const withServerSideSessionMiddleware = ({ auth, storage, graphql, functions, sessionStorage, }) => {
    const mwChain = [
        updateSessionFromResponseMiddleware(sessionStorage),
        attachAccessTokenMiddleware(sessionStorage),
    ];
 ...
 */
export function withAdminSession(adminSession) {
 ...
 */
export function withChainFunctions(chainFunctions) {
